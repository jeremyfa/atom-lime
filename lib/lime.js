...
//Lifecycle
    ...
    activate:function(serialized_state) {
        ...
        atom.contextMenu.add({
            "atom-text-editor" : [
                { type: 'separator' },
                { label: 'Set as active Lime/OpenFL file', command: 'flow:set-lime-file', shouldDisplay: this.display_context.bind(this) },
                { type: 'separator' }
            ],
            ".tree-view .file": [
                { type: 'separator' },
                { label: 'Set as active Lime/OpenFL file', command: 'flow:set-lime-file', shouldDisplay: this.display_context_tree.bind(this) },
                { type: 'separator' }
            ]
        });
