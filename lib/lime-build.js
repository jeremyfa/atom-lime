    ...
    run: function() {
        ...
        var lime = null;
            ...
            if(state.flags.build_only) {
                lime = run_lime.build(null, this._logi, this._loge);
            } else if(state.flags.launch_only) {
                lime = run_lime.launch(null, this._logi, this._loge);
            } else {
                lime = run_lime.run(null, this._logi, this._loge);
            }
