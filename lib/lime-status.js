...
function LimeStatus(_lime) {
    ...
    this.available_targets = {
        'windows': ['windows','html5','android', 'flash', 'blackberry', 'tizen', 'emscripten', 'webos'],
        'mac': ['mac','html5','android','ios', 'flash', 'blackberry', 'tizen', 'emscripten', 'webos'],
        'linux': ['linux','html5','android','ios', 'flash', 'blackberry', 'tizen', 'emscripten', 'webos'],
    }
